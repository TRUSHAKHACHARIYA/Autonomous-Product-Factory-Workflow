...
interface AgentOutput {
  agent_name: string;
  status: string;
  structured_output?: Agent08Output;
  model_used?: string;
  duration_ms?: number;
}

interface Agent08CardProps {
  agent: AgentOutput;
}
...
export function Agent08Card({ agent }: Agent08CardProps) {
        ...
        <div className="p-4 space-y-3">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm font-medium text-gray-700">
              Generating frontend modules in parallel...
            </span>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <ModuleSpinner moduleName="Auth Module" />
            <ModuleSpinner moduleName="Dashboard Module" />
            <ModuleSpinner moduleName="Admin Panel" />
            <ModuleSpinner moduleName="Shared Components" />
          </div>
        </div>
      );
    }
